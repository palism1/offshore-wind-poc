...
cd ~/Desktop/offshore-wind-poc/.claude/worktrees/postgres-repo   # or wherever the branch is
...
- The `fact-checking-grid-architecture` skill is NOT triggered by this task: it is pure
