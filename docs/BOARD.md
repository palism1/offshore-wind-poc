...
- Week 4B spec sync, Phases 0-7 (SWE/CMDR metrics, robustness scoring, hour-ending 1-24, wind multiplier, pooled ETL percentile, integer percentile comparison) [Software] — Owner: Mikko — branch `week4b-spec-sync`, 724 passed / 4 skipped, ruff clean. Phases 8 and 9 (auto-increment ids, efficiency default, daily_budget replacement) not started.
