...
Stress Window Effectiveness \=t=0N(capacity\_dispatched(t)) / t=0N(oil\_generation\_actual(t)+gas\_generation\_actual(t))  
SWE Score: \[0, 0%; 100, 100%\]

Fuel–Fired Generation Offset \=t=0N(oil\_generation(t))+t=0N(gas\_generation(t) )- (t=0Nwind\_generation(t) \+t=0Ncapacity\_dispatched(t))  
...
Recharge Capacity Mismatch= average\_recharge\_mismatch / maximum\_available\_capacity  
RCM Score:
