...
See `docs/PLAN.md` for the full phased plan and `docs/archive/reviews/FACT_CHECK_REPORT.md` for
...
- `examples/real_winter_stress_2026.csv` — real ISO-NE load and real EIA-930
  ...
  `etl demo-profile` (`docs/archive/plans/PLAN_REAL_DEMO_BRIDGE.md`).
...
`docs/archive/plans/PLAN_SCENARIO_PROFILE_FORMAT.md` holds the researched replacement format.
